var boy,mountains,ground,gameOver,cloud;
var edges;
var boyImg,mountainsImg,rock1Img,boyImg2,coinImg,gameoverImg,cloudImg;
...
function spawnCloud(){
   if (World.frameCount % 120 === 0){
      cloud = createSprite (1350,Math.round(random(10,100)),20,20);
      cloud.velocityX = -4;
...
boy.velocityY = boy.velocityY+1.0;
